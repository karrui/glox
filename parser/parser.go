...
// Assertion function that nearly all parsers share.
//
// Primary purpose is to enforce correctness of the order of tokens by checking the type
// of the next token. Iff type is correct does it advance the tokens.
